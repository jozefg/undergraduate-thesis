...
candidates~\citep{Girard:71,Girard:72}. This problem has been a recurring
...
first-order state~\citep{Pitts:98}, simple
exceptions~\citep{TODO-I-DUNNO-SURELY-NOT-NUPRL}, and for recursive
types~\citep{Crary:07}. Despite this work logical
...
Step-indexing is a technique first proposed by \citet{Appel:01}. It
